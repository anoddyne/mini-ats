...
//                "password1"
//        );
//        UserResponseDTO updatedResponse = users.getFirst();
//
//        when(userService.updateUser(eq(id), any(UserRequestDTO.class))).thenReturn(updatedResponse);
//
...
//        Integer id = 1;
//        UserRole newRole = UserRole.CANDIDATE;
//        UserResponseDTO updatedResponse = users.getFirst();
//
